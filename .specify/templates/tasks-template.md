...
**Tests**: Include tests when specified in the feature spec or when required to
validate functional behavior. Do not add tests only to increase test count.
...
### Tests for User Story 1 (when required by spec) ⚠️

> **NOTE: Add only functional tests that validate required behavior**
...
- [ ] T019 [US1] Add UX consistency verification for changed flow/messages
- [ ] T020 [US1] Add performance validation task against defined target
...
### Tests for User Story 2 (when required by spec) ⚠️
...
- [ ] T027 [US2] Verify UX consistency with prior user-facing patterns
- [ ] T028 [US2] Validate performance target for this story
...
### Tests for User Story 3 (when required by spec) ⚠️
...
- [ ] T034 [US3] Verify UX consistency with prior user-facing patterns
- [ ] T035 [US3] Validate performance target for this story
